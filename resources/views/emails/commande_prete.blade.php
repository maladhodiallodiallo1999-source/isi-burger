...
<div style="max-width:600px; margin:auto; background:#fff; padding:30px; border-radius:8px;">
    ...
    <p>Bonne nouvelle ! Votre commande <strong>#{{ $commande->id }}</strong> est <strong style="color:green;">prête</strong> !</p>
    <p>Vous pouvez venir la récupérer.</p>
    ...
    <p>Votre facture est disponible sur votre espace client.</p>
